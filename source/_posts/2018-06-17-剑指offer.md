...
public class Test {
    ...
    /**
     * currentNode：当前节点
     * lastVisitNode：最后访问大节点，同时也是双向链表的最右节点
     */
...
public class Test {
    ...
    public static boolean IsPopOrder(int[] pushA, int[] popA) {
        ...
        while (i < lena) {
            ...
            while (j < lenb && stack.peek() == popA[j]) {
                stack.pop();
                j++;
            }
        }
